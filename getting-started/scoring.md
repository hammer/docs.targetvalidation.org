...
| Affected pathways | Reactome \(functional consequence of 1 for a pathway inferred by a curator\). SLAPenrich is scored according to [Iorio F et al 2018](https://europepmc.org/articles/PMC5928049) and quantified, in large cohorts of cancer patients, the divergence of the total number of samples with genomic alterations in a Reactome-pathway from its expectation, accounting for mutational burdens and total exonic block lengths of genes in that pathway. |
...
| Animal models | [Phenodigm](http://database.oxfordjournals.org/content/2013/bat025) \(similarity score between a mouse model and a human disease described by [Smedley et al 2013](https://europepmc.org/articles/PMC3649640)\) |
