...
Note that some data sources will be down weighted, namely `PROGENy, SLAPenrich and Sysbio`  by a factor of 2, and`Expression Atlas, PhenoDigm and Europe PMC,`downweighted by a factor of 5 \(see the image above for more details\).
