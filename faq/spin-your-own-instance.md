...
{% hint style="danger" %}
Our snapshots have moved to a new [location](https://console.cloud.google.com/storage/browser/open-targets-data-releases) and are available for the current [release 18.10](https://storage.googleapis.com/open-targets-data-releases/18.10/18.10_snapshot) as well as previous ones.
